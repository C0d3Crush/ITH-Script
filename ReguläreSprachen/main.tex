...
\mysubsection{Bemerkung (DEA-Äquivalenzrelation)\(\diamondsuit\)} 
...
\mysubsection{Proposition (DEA-Äquivalenz: Rechtskongruenz)\(\diamondsuit\)} 
...
\mysubsection{Definition(EA aus Rechtskongruenz)} 
...
\mysubsection{Lemma (Erweiterte Übergangsfunktion, Basisfall, Äquivalenzrelation)\(\diamondsuit\)} 
...
\mysubsection{Satz (DEA-Konstruktion: Äquivalenzklassen)\(\diamondsuit\)} 
...
\mysubsection{Korollar (Reguläre Sprachen und Äquivalenzklassen)\(\diamondsuit\)} 
...
\mysubsection{Satz(DEA-Äquivalenz und Rechtskongruenz)\(\diamondsuit\)}
  \begin{itemize}
...
\mysubsection{Bemerkung (Sprach-Äquivalenz und Rechtskongruenz)\(\diamondsuit\)} 
...
\mysubsection{Bemerkung (Partition und Vereinfeinerung)\(\diamondsuit\)} 
...
\mysubsection{Proposition (Äquivalenzpartition und Vereinfeinerung)*} 
