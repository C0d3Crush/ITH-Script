...
\mysubsection{Definition(Landau-Symbole)\(\diamondsuit\)}
...
\mysubsection{Bemerkung(Eigenschaften Landau-Symbole)\(\diamondsuit\)}
...
\mysubsection{Proposition(Binärpalindrome erkennen)\(\diamondsuit\)}
...
\mysubsection{Satz (Zeitbeschränkung einer Turingmaschine)\(\diamondsuit\)}
...
\mysubsection{Satz(Reduktion auf 1-Band-TM)\(\diamondsuit\)}
...
\mysubsection{Satz(Codekonstruktion, Simulation, zeitschranke)\(\diamondsuit\)}
    ...
    \end{proof}
\newpage
\mysubsection{Satz (Universelle TM-Simulation mit Zeitbeschränkung)\(\diamondsuit\)}
    ...
    \end{proof}
\mysubsection{Definition (Zeitbeschränkte Funktionen und Sprachen)\(\diamondsuit\)}
...
\mysubsection{Bemerkung (Polynomielle Zeitkonstruierbarkeit)\(\diamondsuit\)}
    \begin{itemize}
...
\mysubsection{Proposition(Zeitbeschränkte TM-Äquivalenz)\(\diamondsuit\)}
...
\mysubsection{Definition(T-Beschränkte TM und DCOM)\(\diamondsuit\)}
